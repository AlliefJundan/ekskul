                ...
                <div class="bg-white rounded-lg p-6 w-96 shadow-lg">
                    ...
                    <form action="{{ route('ekskul.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_pembina" class="w-full border border-gray-300 rounded-md p-2">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700">Nama Ketua</label>
                            <input type="text" name="nama_ketua" class="w-full border border-gray-300 rounded-md p-2">
                        </div>
                        <div class="mb-4">
