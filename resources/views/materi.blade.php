...
<div class="grid gap-6 mt-8 grid-cols-1 md:grid-cols-3">
    ...
    <div class="bg-ekskul rounded-lg shadow-lg hover:shadow-xl transition duration-300 p-5 flex flex-col 
        ...
        <div class="md:col-span-2 bg-indigo-900 rounded-lg shadow-lg hover:shadow-xl transition duration-300 p-5 min-h-[400px] flex flex-col gap-3">
            @if ($materi->count() > 0)
...
<div id="editModal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
    ...
    <p class="text-sm mt-2">Lampiran saat ini: 
        <a id="editLampiranLink" href="#" target="_blank" class="text-blue-600">Lihat Lampiran</a>
