    ...
    <div class="container mx-auto mt-8 px-4">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
            ...
            <form method="GET" action="{{ route('materi.index', $ekskul->slug) }}" class="flex w-full md:w-auto">
                <input type="text" name="search" value="{{ request('search') }}" class="px-4 py-2 border rounded-l-lg bg-gray-200 w-full md:w-auto" placeholder="Cari materi...">
        ...
        <div class="grid gap-6 mt-8 grid-cols-1 md:grid-cols-3">
            ...
            <div class="bg-ekskul rounded-lg shadow-lg hover:shadow-xl transition duration-300 p-5 flex flex-col justify-center items-center text-center">
                ...
                <p class="text-gray-700 text-bold">
                    <span class="text-xl font-bold text-indigo-900">{{ $ekskul->jml_anggota }}</span> anggota tergabung dalam ekskul ini.
                </p>
            </div>
            ...
            <div class="md:col-span-2 bg-indigo-900 rounded-lg shadow-lg hover:shadow-xl transition duration-300 p-5">
                ...
                @else
                    <h1 class="text-white font-semibold mb-2 text-center">Tidak ada materi tersedia untuk ekskul ini.</h1>
                @endif
            </div>
        </div>
    </div>
