        ...
        <div class="flex justify-end items-center mt-3 mb-3">
            @if ($isAdmin || $isPembina)
                <x-modal trigger="Jabatan" title="Jabatan" class="flex justify-center"
                    buttonClass="relative inline-flex items-center px-4 py-2 text-white bg-ekskul2 font-semibold  rounded-2xl shadow-md hover:shadow-lg hover:-translate-y-1 transition-transform duration-300">
                    @php
                        $jabatanFix = [1, 2, 3, 4];
                    @endphp
